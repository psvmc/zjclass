...
function setTokenParas(pars) {
    var loginuser = zj.getcookie("loginuser");
    if (loginuser && JSON.parse(loginuser)) {
        loginuser = JSON.parse(loginuser)
        pars["ssouserid"] = loginuser["ssouserid"];
        pars["token"] = loginuser["token"];
        pars["usertype"] = loginuser["usertype"];
    }
